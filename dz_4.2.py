...
try:
    ...
    print('не верно введено имя, д.б. с заглавной буквы')
try:
    re.match(pattern, sername).group(1)
except AttributeError:
    print('не верно введена фамилия, д.б. с заглавной буквы')
# print(re.match(pattern, name))
# print(re.match(pattern, sername))

pattern_2 = '([a-z_0-9]+@[a-z0-9]+\.(ru|org|com))'
try:
    re.match(pattern_2, email).group(1)
except AttributeError:
    print('не верно введен адрес электронной почты')
...
print('в файле совпадение более двух точек подряд: ', re.search(pattern_3, some_str))
